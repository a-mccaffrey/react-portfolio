...
const MyModals = ({ title }) => {
let chosenModal = [];

      if (title === "Coding") {
        chosenModal = <CodingModal />
        } 
      else if (title === "Writing") {
        chosenModal = <WritingModal />
        }
      else if (title === "Graphic Design") {
        chosenModal = <GraphicModal />
        }
      else if (title === "Video/Animation") {
        chosenModal = <VideoModal />
        }
      else {
        console.log("something really went wrong here");
      }
      return (
        chosenModal
      )
